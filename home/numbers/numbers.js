...
var imgOrder = ["one", "two", "three", "four", "five", "six", "seven", "eight", "nine"];
// var imgOrder = ["four", "two", "eight", "five", "one", "six", "seven", "nine", "three"];
////var imgOrder = ["one","four","seven","two","five","eight","three","nine","six"];
var swappingOrder =["one", "two", "three", "four", "five", "six", "seven", "eight", "nine"];
////var swappingOrder =["one","four","seven","two","five","eight","three","nine","six"];
var target = ["one","four","seven","two","five","eight","three","six","nine"];
...
function dragEnd() {
    if (!otherTile.src.includes("nine.jpg")) {
        return;
    }
